...
static const Vtx grill_seg7_vertex_0701FDC8[] = {
...
static const Vtx grill_seg7_vertex_0701FEB8[] = {
...
static const Gfx grill_seg7_dl_0701FF68[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, generic_09000000),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(grill_seg7_vertex_0701FDC8, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 3,  5,  6, 0x0,  7,  8,  9, 0x0),
    gsSP2Triangles( 7,  9, 10, 0x0, 11, 12, 13, 0x0),
    gsSP1Triangle(11, 13, 14, 0x0),
    gsSPVertex(grill_seg7_vertex_0701FEB8, 11, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx grill_seg7_dl_0701FFF8[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(grill_seg7_dl_0701FF68),
