...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(5, bob_dl_nocol_mesh_layer_5),
		GEO_DISPLAY_LIST(1, bob_dl_nocol_mesh_layer_1),
		GEO_DISPLAY_LIST(6, bob_dl_nocol_mesh_layer_6),
		GEO_DISPLAY_LIST(4, bob_dl_nocol_mesh_layer_4),
		GEO_DISPLAY_LIST(4, bob_dl_op_mesh_layer_4),
		GEO_DISPLAY_LIST(1, bob_dl_op_mesh_layer_1),
		GEO_DISPLAY_LIST(5, bob_dl_op_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_op_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
